        ...
        <div className="flex flex-col items-center min-h-screen py-2 border-b-2 bg-blue-light">
          <main className="flex flex-col items-center w-full flex-1 px-20 text-center mb-12 h-10">
            <h1 className=" mt-16 text-6xl font-bold">
              Welcome to <a className="text-blue-400">Summ</a>
            </h1>
            <div className="flex flex-row">
              ...
              >
                <button className="bg-emerald-500 text-white font-bold py-5 px-5 rounded mt-8 mr-3 ">
                  Create a Summ
                </button>
              </Link>

              <button className="bg-blue-400 text-white font-bold py-5 px-5 rounded mt-8 ml-3">
                Join a Summ
              </button>
            </div>
          </main>
